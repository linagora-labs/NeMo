...
# cuDNN/THC convolution kernels index tensor elements with 32-bit integers, so any
# tensor entering or leaving a conv must hold fewer than this many elements; exceeding
